...
export const TodoItem = ({ todo, onDeleteTodo, onToogle }) => {
    return (
        ...
        <li 
            key={todo.id} 
            className={`${(todo.done) ? 'list-group-item list-group-item-danger d-flex justify-content-between tachado' : 'list-group-item list-group-item-success d-flex justify-content-between'}`} 
